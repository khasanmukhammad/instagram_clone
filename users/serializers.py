...
from .models import User, UserConfirmation, VIA_PHONE, VIA_EMAIL, NEW, DONE, CODE_VERIFIED, PHOTO_DONE
...
class ChangeUserPhotoSerializers(serializers.Serializer):
    photo = serializers.ImageField(validators=[FileExtensionValidator([".jpg", ".jpeg", "png", ".heic", ".heif"])])
